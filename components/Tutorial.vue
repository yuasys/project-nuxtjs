  ...
  >
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-4"><span class="text-slate-700 text-xs bg-gray-300">（日本語訳）</span><a
            href="https://nuxtjs.org"
            target="_blank"
            class="button--doc text-green-500 hover:underline"
            >Nuxtドキュメント</a
        ...
        <p class="m-4">
          <span class="text-slate-700 text-xs bg-gray-300">（日本語訳）</span>
          まずは、components/Tutorial.vueを削除して、pages/index.vueからコーディングを始めてください。楽しんでください！
        </p>
      </div>
